...
observeEvent(input$twitter_submit_button, {
  showModal(modalDialog("Fetching Twitter Data ...", footer=NULL))
...
# 
#   showNotification( strong( 'Fetching Twitter Data. Please Wait ...' ), type = 'message' )
# 
# })

# showNotification( strong( 'Data Fetching Completed' ), type = 'message' )
